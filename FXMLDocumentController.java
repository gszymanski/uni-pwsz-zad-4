...
public class FXMLDocumentController implements Initializable {
	...
	private void refreshLabels() {
		fxBalance.setText("Bilans: " + balance);
		fxBet.setText("Zakład: " + bet);
		fxPointsCasino.setText("Punkty: " + pointsCasino.value);
		fxPointsPlayer.setText("Punkty: " + pointsPlayer.value);
		fxPointsPlayerSplit.setText("Punkty: " + pointsPlayerSplit.value);
	}
	...
	private void checkPlayerPoints(Boolean end) {
		...
		if (pointsPlayer.value > 21 || (end && (pointsCasino.value <= 21) && (pointsPlayer.value < pointsCasino.value))) {
			...
			a.setTitle("Przegrana!");
			a.setHeaderText(null);
			a.setContentText("Przegrana!");
			a.showAndWait();
	...
	private void fxStartClick(ActionEvent event) {
		if (bet < 1) {
			...
			a.setTitle("Błąd!");
			a.setHeaderText(null);
			a.setContentText("Stawka nie może być pusta!");
			a.showAndWait();
			return;
		}
